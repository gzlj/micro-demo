...
func (c *greeterService) SayHello(ctx context.Context, in *HelloRequest, opts ...client.CallOption) (*HelloResponse, error) {
...
func (h *greeterHandler) SayHello(ctx context.Context, in *HelloRequest, out *HelloResponse) error {
